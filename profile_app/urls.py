...
from .views import (
                    ...
                    hx_update_view,
                    hx_delete_education,
                    hx_create_profile_education_view,
                    hx_delete_exp,
                    hx_create_profile_exp_view,
                    )
...
urlpatterns = [
    ...
    path('<int:pk>/update/education-add/', hx_create_profile_education_view, name='profile-education-add'),
    ...
    path('<int:pk>/update/exp-add/', hx_create_profile_exp_view, name='profile-exp-add'),
